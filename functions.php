...
function esell_scripts() {
	wp_enqueue_style( 'esell-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'esell-style', 'rtl', 'replace' );

	wp_enqueue_script( 'esell-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
