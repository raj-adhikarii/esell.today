                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 106px; gap: 6px; display: grid; place-items: center; grid-template-columns: 1fr 1fr;">
                                                ...
                                                <a href="#" class="btn btn-outline-danger btn-sm rounded-2 delete-product" data-bs-toggle="tooltip" title="Delete" data-product-id="<?php echo $product_id ?>"><i class="far fa-trash-can"></i></a>
                                            </td>
                                        </tr>
                                        <?php $count++; endwhile; ?>
                                    </tbody>
